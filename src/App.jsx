...
// import CreateListingWithAbstraxion from "./pages/admin/create-listing/connect";
    ...
    <>
      <BrowserRouter>
        <Provider store={store}>
          <Routes>
            <Route path="/">
              <Route index element={<ListingGridPage6 />} />
              ...
              <Route path="listing-grid-v1" element={<ListingGridPage6 />} />
